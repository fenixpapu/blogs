...
- `kube-proxy` là 1 k8s component giúp k8s service hoạt động:
  ...
  - Summary: `traffic manager` cho k8s service.
- `vpc-cni` là một network plugin cung cấp cho pods địa chỉ IP của AWS VPC:
